...
CREATE TABLE "contests" (
    ...
    "current_prize_pool" DECIMAL(20,8) NOT NULL DEFAULT 0,
...
CREATE TABLE "user_achievements" (
    ...
    "category" VARCHAR(20) NOT NULL DEFAULT 'CONTESTS',
...
CREATE TABLE "users" (
    ...
    "last_level_up" TIMESTAMPTZ(6),
    "profile_image_url" VARCHAR(255),
    "profile_image_updated_at" TIMESTAMPTZ(6),
    "last_balance_check" TIMESTAMPTZ(6),
...
-- CreateIndex
CREATE INDEX "idx_users_experience_points" ON "users"("experience_points" DESC);
...
-- AddForeignKey
ALTER TABLE "user_achievements" ADD CONSTRAINT "user_achievements_wallet_address_fkey" FOREIGN KEY ("wallet_address") REFERENCES "users"("wallet_address") ON DELETE SET NULL ON UPDATE NO ACTION;
